...
export default function New() {
  return (
    <>
      ...
      <form action={createTodo} className="flex gap-2 flex-col mb-2">
        <input type="text" name="title" className="border border-slate-300 bg-transparent rounded px-2 py-1 outline-none" />
